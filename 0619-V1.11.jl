# ESBL-producing Enterobacterales Dynamic ABM in Tanzanian NICUs (version 1.11)
# Luyuan Zhao 
# 2025-06-19 
# adjustments:
# 1. Added environmental reservoir contamination to the model, which can contaminate HCWs, devices and babies.
# 2. Improved parameter handling by assembling parameters into a tuple for easy modification.
